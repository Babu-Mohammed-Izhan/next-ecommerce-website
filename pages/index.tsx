  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-6 pt-3">
        <div className="h-64 rounded-md overflow-hidden bg-cover bg-center bg-all-cases">
          <div className="bg-gray-900 bg-opacity-60 flex items-center h-full">
            <div className="px-10 max-w-xl">
              ...
              <p className="mt-2 text-gray-300">High Quality cases.</p>
              <button
        ...
        <div className="md:flex mt-8 md:-mx-4">
          <div className="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center bg-anime-cases md:w-1/2">
            <div className="bg-gray-900 bg-opacity-60 flex items-center h-full">
              <div className="px-10 max-w-xl">
                ...
                <p className="mt-2 text-gray-300">
                  Anime cases from your favourite animes.
                </p>
                <button
          ...
          <div className="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center bg-superhero-cases md:mt-0 md:w-1/2">
            <div className="bg-gray-900 bg-opacity-60  flex items-center h-full">
              <div className="px-10 max-w-xl">
                <h2 className="text-3xl text-white font-semibold">
                  Super Hero Cases
                ...
                <p className="mt-2 text-gray-300">
                  All your popular superhero cases in all phone models.
                </p>
                <button
                  className="flex items-center mt-4 px-2 py-2  bg-gradient-to-r from-blue-600 
                 to-purple-600 text-white text-sm uppercase font-medium rounded hover:from-blue-500 hover:to-purple-500 focus:outline-none "
